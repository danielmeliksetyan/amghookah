...
(() => {
  ...
  function boot(runtime, doc = document) {
    ...
    // The document has already been parsed above, so this fetch is only an
    // optional source refresh. Chrome assigns opaque origins to file:// URLs
    // and logs an "Unsafe attempt to load URL" error when a local page fetches
    // itself. Skip the refresh in standalone file previews; hosted pages keep
    // the live-source update unchanged.
